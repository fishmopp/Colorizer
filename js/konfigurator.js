...
function startKonfigurator(drachenSrc, farbenSrc) {
    ...
    /* Hier die URL vom Bild des Drachens einfügen*/
    ...
    /* Hier die URL vom Bild der Drachenfraben einfügen*/
...
$('#drachen').click(function (e) {
    ...
    if (drachen.getContext) {
        ...
        /*Fläche füllen
         * Wenn auf einen schwarzen Bereich geklickt wurde wird fill4 nicht ausgeführt.
         */
...
/*
 Um die Position eines Objektes auf der Seite finden zu können.
 */
